...
// g++ select_server.cpp -o select_server -g -w --std=c++17 -lpthread
...
trace("master_socket="<<master_socket << ", max_sd="<<max_sd << ", sd="<<sd);
...
trace("master_socket="<<master_socket << ", max_sd="<<max_sd << ", new_socket="<<new_socket << ", sd="<<sd);
