...
public class MyApplet extends Applet 
{
	...
	public void init()
	{
		...
		okButton = new Button("Bbutton");
		// text and length of the field
		nameField = new TextField("my TextField",100);
		...
		// same but selected	
		radio2 = new Checkbox("Radio 2", radioGroup,true);
		...
		//read properties
//		String	sPropFile	= getParameter("codebase") + getParameter("PropertiesFile");
		String	sPropFile	= getParameter("PropertiesFile");
		nameField.setText(sPropFile);
		Properties properties = new Properties();
		try{
			properties.load(new FileInputStream(sPropFile));
		}catch(IOException e){}
		String sName = properties.getProperty("Name");
		String sPhone= properties.getProperty("Phone");
		
		nameField.setText("Name="+sName + " Ph:"+sPhone);
